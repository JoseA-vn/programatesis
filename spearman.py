...
spearmam = open('C:/Users/jvera/Desktop/Nuevacarpeta/programatesis/archivos/LT/bitcoin/spearman.csv','w',newline='')
escribir = csv.writer(spearmam, delimiter=';')
escribir.writerow(['direccionalidad','máximos','promedios'])
bitcoin = open(
    'C:/Users/jvera/Desktop/Nuevacarpeta/programatesis/archivos/LT/bitcoin/bitcoinEst.csv', 'r')
lineas = bitcoin.readlines()
lineas.pop(0)
