...
archivos = os.listdir('C:/Users/jvera/Desktop/Nueva carpeta/programatesis/archivos/LT/football/resultados')

football = open('C:/Users/jvera/Desktop/Nueva carpeta/programatesis/archivos/LT/football/footballEst.csv','w',newline='')
...
for i in archivos:
    documento = open('C:/Users/jvera/Desktop/Nueva carpeta/programatesis/archivos/LT/football/resultados/'+i, 'r')
