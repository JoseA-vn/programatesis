...
archivos = os.listdir('C:/Users/jvera/Desktop/Nuevacarpeta/programatesis/archivos/LT/higgs/resultados')

higgs = open('C:/Users/jvera/Desktop/Nuevacarpeta/programatesis/archivos/LT/higgs/higgsEst.csv','w',newline='')
...
for i in archivos:
    documento = open('C:/Users/jvera/Desktop/Nuevacarpeta/programatesis/archivos/LT/higgs/resultados/'+i, 'r')
